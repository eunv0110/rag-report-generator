...
설정: BGE-M3 + RRF Ensemble (Top 6) + GPT-4.1
"""
...
class WeeklyReportGenerator:
    ...
    설정:
    - Retriever: BGE-M3 + RRF Ensemble (Top 6)
    - LLM: GPT-4.1
    """
    ...
    def __init__(self):
        ...
        self.qdrant_lock = "/home/work/rag/Project/rag-report-generator/data/qdrant_data/baai-bge-m3/.lock"

    def load_prompt(self, prompt_file: str) -> str:
        """프롬프트 파일 로드"""
        prompt_path = Path(__file__).parent.parent / "prompts" / "templates" / "service" / "weekly_report" / prompt_file
    ...
    def generate_answer(self, question: str, docs: List[Any]) -> str:
        ...
        with self.langfuse.start_as_current_observation(
            ...
            self.langfuse.update_current_trace(
                tags=["weekly_report", self.retriever_config['name'], self.llm_config['name']],
                output={"answer": answer}
            )
